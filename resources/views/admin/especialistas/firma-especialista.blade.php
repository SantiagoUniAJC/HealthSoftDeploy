...
@section('subtitle', 'Especialista Firmar')
        ...
        <div class="container">
            <div class="card card-secondary card-outline mt-3">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="card-title">Crear Firma del {{ $especialista->especialidad_medica }}: <span
                                    class="text-bold text-lightblue font-italic">
                                    {{ $especialista->nombres . ' ' . $especialista->apellidos }} </span></h3>
                        </div>
                        <p class="col-md-2"></p>
                        <div class="col-md-4">
                            <a href="{{ route('admin.especialista.especialistas.show', $especialista->id) }}" type="submit"
                ...
                <div class="card-body">
                    <div class="text-center">
                        <div id="signature-pad" class="signature-pad">
                            <form action="guardarfirmaEspecialista" enctype="multipart/form-data" method="post">
                                @csrf
                                {{-- Agregar un campo oculto para el ID del especialista --}}
                                <x-adminlte-input type="hidden" id="especialista_id" value="{{ $especialista->id }}"
                                ...
                                <x-adminlte-button label="Guardar Firma" type="submit" theme="outline-success"
                                    icon="fas fa-thumbs-up" id="btnGuardarFirmaEspecialista" hidden>
                                    Guardar Firma
                                </x-adminlte-button>
                            </form>
                            <div class="mt-3">
                        ...
                        <button class="btn btn-outline-success mt-3" id="btnCrearFirmaEspecialista">Crear Firma</button>
    ...
    <script>
        window.onload = () => {
            ...
            const $canvas = document.querySelector("#canvas"),
                $btnCrearFirmaEspecialista = document.querySelector("#btnCrearFirmaEspecialista"),
                $btnLimpiar = document.querySelector("#btnLimpiar"),
                $btnGuardarFirmaEspecialista = document.querySelector("#btnGuardarFirmaEspecialista");
            ...
            $btnCrearFirmaEspecialista.onclick = () => {
                ...
                $btnCrearFirmaEspecialista.style.display = "none";
                $btnLimpiar.style.display = "none";
                $btnGuardarFirmaEspecialista.style.display = document.getElementById("btnGuardarFirmaEspecialista")
                    .removeAttribute(
                        "hidden");
            }
