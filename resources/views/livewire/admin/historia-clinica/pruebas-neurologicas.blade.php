                    ...
                    <div class="col-md-2">
                        <div class="card border-warning mb-3">
                            <div class="card-header bg-warning text-light">
                                <i class="fas fa-lg fa-tasks"></i> Historia Clínica 8 - 12
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                <form wire:submit='guardarPruebasNeurologicas'>
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-8">
                            <x-adminlte-input wire:model='observaciones_equilibrio' name="observaciones_equilibrio"
                                label="Observaciones Equilibrio" label-class="text-lightblue">
                                <x-slot name="prependSlot">
                                    <div class="input-group-text">
                                        <i class="fas fa-brain"></i>
                                    </div>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <x-adminlte-input wire:model='prueba_phalen' name="prueba_phalen" label="Prueba Phalen"
                                label-class="text-lightblue">
                                <x-slot name="prependSlot">
                                    <div class="input-group-text">
                                        <i class="fas fa-bone"></i>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <x-adminlte-input wire:model='prueba_gerber' name="prueba_gerber" label="Prueba Gerber"
                                label-class="text-lightblue">
                                <x-slot name="prependSlot">
                                    <div class="input-group-text">
                                        <i class="fas fa-bone"></i>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <x-adminlte-select wire:model='babinsky_weil' name="babinsky_weil" label="Babinsky Weil"
                                label-class="text-lightblue">
                                <x-slot name="prependSlot">
                                    <div class="input-group-text">
                                        <i class="fas fa-exclamation-triangle"></i>
