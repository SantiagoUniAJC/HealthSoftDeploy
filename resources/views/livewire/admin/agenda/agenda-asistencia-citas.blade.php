        ...
        <div class="col-md-12">
            <div class="card card-success card-outline mt-3">
                <div class="card-header">
                    <div class="row">
                        <h3 class="card-title col-md-2">Confirmación de Citas</h3>
                        <p class="col-md-4"></p>
                        <div class="col-md-5">
                                ...
                                <tbody>
                                    @foreach ($citas as $cita)
                                        <tr>
                                            ...
                                            <td>
                                                <button wire:click="$dispatch('confirmUser', {{ $cita->id }}, 'confirmar')"
                                                    class="btn btn-success btn-sm">Confirmar</button>
                                                <button wire:click="$dispatch('cancelUser', {{ $cita->id }}, 'cancelar')"
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-6">{{ $citas->links() }}</div>
